...
if(isset($_POST['submit'])){
   ...
   if(mysqli_num_rows($result) > 0){
      ...
      if($password != $cpassword){
         ...
         $insert = "INSERT INTO `users` (fullname,username,  password,email, phoneno,gender) VALUES('$fullname','$username','$password','$email','$phoneno','$gender')";
...
<div class="form-container">
   ...
   <form action="" method="post">
      ...
      <p>already have an account?<a href="user_login1.php">Login Now</a></p>
