...
if(isset($_POST['submit'])){
   ...
   $select = mysqli_query($conn, "SELECT * FROM `admindoctor_details` WHERE username = '$username' AND password = '$password'") or die('query failed');
  ...
  <div class="text-box">
    ...
    <?php
      ...
      ?>
         ...
         <div class="labels">
          <label id="username-label" for="username">*  UserName</label></div>
        <div class="input-tab">
          <input class="input-field" type="username" name="username" placeholder="Enter your profile username" required></div>

         <div class="labels">
          <label id="password-label" for="password">* Password</label></div>
        <div class="input-tab">
          <input class="input-field" type="password"  name="password" placeholder="enter your profile password" required></div>
      ...
      <p>don't have an account? <a href="doctor_details.php"style="color:yellow">regiser now</a></p>
    </div>
