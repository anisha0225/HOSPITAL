...
if(isset($_POST['profile_update'])){
    ...
    mysqli_query($conn, "UPDATE `admin` SET username = '$update_name', email = '$update_email' WHERE id = '$id'") or die('query failed');
    ...
    mysqli_query($conn, "UPDATE `admin` SET username='$update_name' ,fullname = '$update_fullname',email='$update_email',phoneno='$update_phoneno',gender='$update_gender'  WHERE id = '$id'") or die('query failed');
...
<div class="update-profile">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <a href="passupdate.php" class="delete-btn">update password</a>
   </form>
